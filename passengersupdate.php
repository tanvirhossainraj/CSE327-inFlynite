...
<ul class="nav navbar-nav navbar-right">
	...
	<li class="nav-download-btn"><a href="searchpagepassengers.php">Back</a></li>
</form>
</ul>
</div>
<!-- .navbar-collapse --></div>
				...
				<div class="service-box3">
					 <div class="container-fluid" >
							...
							<input type="text" placeholder="Enter flight arriving from.." value="<?php echo $destination ?>" style="margin-left: 100px;" name="fadest" required>
							  <br>
							<label>Date: </label>
							<input type="Date" placeholder="Enter gate number" value="<?php echo $gate ?>" style="margin-left: 100px;" name="fagate" required>
								<br>							  
							...
							<input type="text" placeholder="Enter flight status" value="<?php echo $flightnum  ?>" style="margin-left: 100px;" name="fafno" required>
							  <br><br>
							  <label>Flight Time: </label>
							<input type="text" placeholder="Enter flight status" value="<?php echo $flighttime ?>" style="margin-left: 100px;" name="fatime" required>
							  <br><br>
							   <label>Airlines: </label>
							<input type="text" placeholder="Enter flight status" value="<?php echo $flightair ?>" style="margin-left: 100px;" name="fair" required>
							  <br><br>
							   <label>Destination: </label>
							<input type="text" placeholder="Enter flight status" value="<?php echo $flightdest ?>" style="margin-left: 100px;" name="fadestin" required>
							  <br><br>
...
<div class="row">
<div class="col-sm-12">
<h2>How to update passenger details?</h2>

<p>Please make changes to the details wherever you think is necessary for passengers information.</p>
</div>
</div>
</div>
</section>
