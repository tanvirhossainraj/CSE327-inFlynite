	...
	<nav class="navbar navbar-default" id="main-nav">
		<div class="container">
			<div class="row">
				...
				<h1 style="color: white;display:inline;font-family: Comic Sans MS;padding-top:20px;font-size:50px;">inFlynite</h1></div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="nav-download-btn"><a href="index.php">Back</a></li>
				</ul>
				</div>
				<!-- .navbar-collapse -->
...
<section class="whocanbeourdriver" id="whocanbeourdriver">
	<div class="container">
		<div class="row">
			...
			<p>As long as you have logged in succesfully, you can manage the tables given above in whatever steps you need to take, may it be edit, delete or insert!</p>
			</div>
		</div>
	</div>
</section>
