			...
			<div class="col-md-12 col-sm-12">
				<div class="service-box3">
					 <div class="container-fluid" >
							...
							<label>Name: </label>
							<input type="text" placeholder="Enter passenger name.." style="margin-top: 50px;" name="pname"  required>
							  <br>
							<label>Age: </label>
							<input type="text" placeholder="Enter passenger's age.."  name="page" required>
							  <br>
							<label>Email: </label>
							<input type="text" placeholder="Enter passenger's email..."  name="pemail" required>
								<br><br> 							  
							<label>Date: </label>
							<input type="date" placeholder="Enter departuring date..."  name="pdate" required>
								<br><br> 							  
							<label>Ticket Number: </label>
							<input type="text" placeholder="Enter ticket number...."  name="pticket" required>
							  <br><br>
							  <label>Flight Number: </label>
							<input type="text" placeholder="Enter flight number...."  name="pflight" required>
							  <br><br>
							  <label>Flight Time: </label>
							<input type="text" placeholder="Enter flight time...."  name="pflighttime" required>
							  <br><br>
							  <label>Airlines: </label>
							<input type="text" placeholder="Enter airline name...." name="pairlines" required>
							  <br><br>
							  <label>To: </label>
							<input type="text" placeholder="Enter destination...."  style="margin-bottom: 50px;" name="pto" required>
							  <br><br>
								<div class="row">
								<div class="col-lg-12" align="center">
								<button type="submit" name="arrivalsend" style="margin-bottom: 50px;" class="savebtn">Save</button>
								</div>	
								</div>
							</div>							
								</form>
