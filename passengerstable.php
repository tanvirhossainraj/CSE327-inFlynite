...
<ul class="nav navbar-nav navbar-right">
	...
	<li class="nav-download-btn"><a href="start.php">Back</a></li>
</form>
</ul>
</div>
<!-- .navbar-collapse --></div>
...
<!--Modal starts-->
				...
				<form class="modal-content3 animate" action="/action_page.php">
							...
							<div class="container">
							  ...
							  <a href="passengers2.php" style="background-color:white;color:#ef494d;border:1px solid white;padding:10px;" class="insertbtn"><b>Insert</b></a>
							  <br><br><br>
							  <div><p style="font-size:25px;"><b>Or you could search your flight to edit or delete!</b></p></div><br>
							  <a href="searchpagepassengers.php"  style="background-color:white;color:#ef494d;border:1px solid white;padding:10px;" class="insertbtn"><b>Edit</b></a>
							  <a href="searchdeletepassengers.php" style="background-color:white;color:#ef494d;border:1px solid white;padding:10px;" class="insertbtn"><b>Delete</b></a>
							</div>
							<br>
...
<div class="row">
<div class="col-sm-12">
<h2>How to manage passengers?</h2>

<p>Please make sure you type in the exact passenger name, age, email, flight number, flight time, airlines and their destinations respectively. They must be precise according to the International Aviation Rules</p>
</div>
</div>
</div>
</section>
