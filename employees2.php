			...
			<div class="col-md-12 col-sm-12">
				<div class="service-box3">
					 <div class="container-fluid" >
							...
							<label>NAME: </label>
							<input type="text" placeholder="Enter employee name.." name="ename" style="margin-left: 40px;" required>
							  <br>
							<label>CONTACT: </label>
							<input type="text" placeholder="Enter employee's contact number.." style="margin-left: 40px;" name="econt" required>
							  <br>
							<label>ADDRESS: </label>
							<input type="text" placeholder="Enter employee's address..." style="margin-left: 40px;" name="eaddress" required>
								<br><br> 							  
							<label>AIRLINES: </label>
							<input type="text" placeholder="Enter the airline working on...." style="margin-left: 40px;" name="eairlines" required>
							  <br><br>
...
<div class="row">
<div class="col-sm-12">
<h2>How to insert information about employees?</h2>

<p>Please fill up all the necessary fields shown above regarding the details of the employees leaving and entering the airports</p>
</div>
</div>
</div>
</section>
