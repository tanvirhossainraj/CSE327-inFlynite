...
<ul class="nav navbar-nav navbar-right">
	...
	<li class="nav-download-btn"><a href="start.php" class="login">Back</a></li>
</form>
</ul>
</div>
<!-- .navbar-collapse --></div>
...
<!--Modal starts-->
				...
				<form class="modal-content3 animate" action="/action_page.php">
							...
							<div class="container">
							  ...
							  <a href="airlines2.php" style="background-color:white;color:#ef494d;border:1px solid white;padding:10px;" class="insertbtn"><b>Insert</b></a>
							  <br><br><br>
							  <div><p style="font-size:25px;"><b>Or you could search your flight to edit or delete!</b></p></div><br>
							  <a href="searchpageairlines.php" style="background-color:white;color:#ef494d;border:1px solid white;padding:10px;" class="insertbtn"><b>Edit</b></a>
							  <a href="searchdeleteairlines.php" style="background-color:white;color:#ef494d;border:1px solid white;padding:10px;" class="insertbtn"><b>Delete</b></a>
							</div>
							<br>
...
<div class="row">
<div class="col-sm-12">
<h2>How to manage information about airlines?</h2>

<p>Please fill up all the necessary fields shown above regarding the details of the airlines leaving and entering the airports as per say of the International Aviation Rule.</p>
</div>
</div>
</div>
</section>
