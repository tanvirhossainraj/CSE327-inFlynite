            ...
            <div class="row">
                <div class="col-md-7 col-sm-7 intro-info wow fadeIn">
                    <div class="intro-info-content">
                        <h1>when its about flights <br/> <span>inFlynite</span> is your easiest, quickest & cost effective solution!</h1>
                        <h4><b>inFlynite is an application-based management service that promises speed, security, and most of all its efficiency!</b></h4>
						<div class="container">
