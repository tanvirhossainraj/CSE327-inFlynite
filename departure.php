...
<!--Modal starts-->
<div id="id01" class="modal" style="background-color: #EF494D;margin-top: 100px;margin-left: 600px;height:700px;width: 800px;">
				<form class="modal-content3 animate" style="height:200px;width: 400px;" action="/action_page.php">
							...
							<div class="container" style="width: 400px">
							  <h1 style="color:white;margin-left: 50px;">Manage your flights</h1>
							  <p style="font-size:25px;color:black;"><b>Add a flight info to the table!</b></p><br>
							  <a href="departures2.php"  style="background-color:white;color:#ef494d;border:1px solid white;padding:10px;border-radius:10px;"  class="insertbtn"><b>Insert</b></a>
							  <br><br><br>
							  <div><p style="font-size:25px;color:black;"><b>Or you could search your flight to edit or delete!</b></p></div><br>
							  <a href="searchpagedepartures.php"  style="background-color:white;color:#ef494d;border:1px solid white;padding:10px;border-radius:10px;"  class="insertbtn"><b>Edit</b></a>
							  <a href="searchdeletedepartures.php"  style="background-color:white;color:#ef494d;border:1px solid white;padding:10px;border-radius:10px;"  class="insertbtn"><b>Delete</b></a>
							</div>
							<br>
...
<div class="row">
<div class="col-sm-12">
<h2>How to manage departures?</h2>

<p>Please make sure when you enter the flight numbers and destinations, they must be in capital letters according to International Aviation Rules and please do keep in mind there are twelve gates here in Hazrat Shahjalal International Airport with six blocks attached to it starting from A to F.</p>
</div>
</div>
</div>
</section>
...
<ul class="list-unstyled">
	<li><a href="#top"><i class="fa fa-angle-up"></a></li>
</ul>
