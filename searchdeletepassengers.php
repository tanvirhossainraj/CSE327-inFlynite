...
<ul class="nav navbar-nav navbar-right">
	...
	<li><a data-scroll="" href="index.php#contact">Contact</a></li>
		<li class="nav-download-btn"><a href="passengerstable.php">Back</a></
</form>
</ul>
</div>
<!-- .navbar-collapse --></div>
				...
				<div class="service-box3">
					 <div class="container-fluid" >
						    ...
						    <label  style="margin-left:300px;">Passenger Name: </label>
							 <input  style="margin-left:300px;" type="text" placeholder="Enter name.." name="passenger" style="margin-left: 150px;"required>
							<br>
...
<div class="row">
<div class="col-sm-12">
<h2>How to remove passengers from the table?</h2>

<p>Please press delete to remove any passenger you need to from the table.</p>
</div>
</div>
</div>
</section>
