...
<!--Modal starts-->
				...
				<form class="modal-content3 animate" action="/action_page.php">
							...
							<div class="container">
							  ...
							  <a href="employees2.php" style="background-color:white;color:#ef494d;border:1px solid white;padding:10px;" class="insertbtn"><b>Insert</b></a>
							  <br><br><br>
							  <div><p style="font-size:25px;"><b>Or you could search your flight to edit or delete!</b></p></div><br>
							  <a href="searchpageemployees.php"  style="background-color:white;color:#ef494d;border:1px solid white;padding:10px;" class="insertbtn"><b>Edit</b></a>
							  <a href="searchdeleteemployees.php" style="background-color:white;color:#ef494d;border:1px solid white;padding:10px;" class="insertbtn"><b>Delete</b></a>
							</div>
							<br>
...
<div class="row">
<div class="col-sm-12">
<h2>How to manage employees?</h2>

<p>Please make sure you type in the exact employee name,  email, contact and airlines respectively. They must be precise according to the International Aviation Rules</p>
</div>
</div>
</div>
</section>
